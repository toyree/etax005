...
public class DssHelper {
	...
	public COSDictionary createDssDictionary(Iterable<byte[]> certifiates, Iterable<byte[]> crls,
			Iterable<byte[]> ocspResponses) throws IOException {
	...
	public List<CRL> readCRLsFromCert(X509Certificate cert) throws Exception {
